...
if __name__ == '__main__':
    x_train = np.loadtxt('data/regression/x_train.txt').reshape((-1, 1))
    y_train = np.loadtxt('data/regression/y_train.txt').reshape((-1, 1))
    ...
    x_test = np.loadtxt('data/regression/x_test.txt').reshape((-1, 1))
    ...
    ani.save('baseline_regression.gif')
